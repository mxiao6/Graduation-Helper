...
describe('User tests', function () {
  ...
  it('it should login successfully', function (done) {
    chai
      .request(server)
      .post('/login')
      .send({ email: 'admin@gmail.com', password: 'test2' })
      .end((err, res) => {
  ...
  it('it should not login wrong password', function (done) {
    chai
      .request(server)
      .post('/login')
      .send({ email: 'admin@gmail.com', password: 'wrong_pass' })
      .end((err, res) => {
        res.should.have.status(422);
  ...
  it('it should not login no existing email', function (done) {
    chai
      .request(server)
      .post('/login')
      .send({ email: 'NOEMAIL@gmail.com', password: 'NOEMAIL' })
      .end((err, res) => {
        res.should.have.status(422);
  ...
  describe('General schedule tests', function () {
    ...
    it('should give us a schedule animal science', function (done) {
      ...
      chai
        .request(server)
        .post('/schedule/generate')
        .send({ year: '2018', semester: 'Spring', courses: ['ANSC250'] })
        .end((err, res) => {
          res.should.have.status(200);
          res.body.should.be.a('Object');
          res.body.should.have.nested.property('numOfSchedules');
    ...
    it('should not give us a schedule because of incorrect Parameters', function (done) {
      chai
        .request(server)
        .post('/schedule/generate')
        .send({ semester: 'blah', courses: ['ANSC250'] })
        .end((err, res) => {
          res.should.have.status(422);
      ...
      it('should give us a schedule that meets all preferences 3', function (done) {
        ...
        chai
          ...
          .send({
            ...
            preferences: {
              noClassDays: ['M', 'W', 'F'],
              noClassOptions: ['evening', 'morning'],
              noClassTime: [
                {
                  start: 7,
                  end: 8
...
describe('API tests', function () {
  ...
  it('it should get all major for given year and semester', function (done) {
    chai
      .request(server)
      .get('/api/subject')
      .query({ year: '2018', semester: 'spring' })
      .end((err, res) => {
        res.body.should.be.a('array');
  ...
  it('it should get all course for given year, semester, major', function (done) {
    chai
      .request(server)
      .get('/api/course')
      .query({ year: '2018', semester: 'spring', course: 'AAS' })
      .end((err, res) => {
        res.body.should.be.a('array');
